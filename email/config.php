...
$recipient = "aabid.test123@gmail.com";  // Please insert your email address (between the quotation marks)

$yourname    = "Aabid";  // Please insert your name here (between the quotation marks) It will appear as the sender in the thank-you mail.

$cfg['DATA_PRIVACY_POLICY'] = 1;  //  0 = Without data privacy policy   1 = With data privacy policy
